...
function gotoGoogleJob(e){
    ...
    console.log(e.target.term.value)
    let term = e.target.term.value
    const searchUrlJobs = `https://www.google.com/search?q=${term}+site%3Ahttps%3A%2F%2Fgreenhouse.iom%2F+OR+site%3Ahttps%3A%2F%2FMyworkdayjobs.com%2F+OR+site%3Ahttps%3A%2F%2Fapply.workable.com%2F+OR+site%3Ahttps%3A%2F%2Flever.co`
    console.log(searchUrlJobs)
    window.location.href=searchUrlJobs
}
